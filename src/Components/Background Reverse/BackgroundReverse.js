    ...
    return (
        <div>
            <div className="home__info">
                ...
                <div className="info">
                    <p>I Chetan Kabra Worked As Assistant Professor In Pemraj Sarda College For 7 Years. During This Time , I Taught Several Programming Languages Like <br/>JAVA C C++ VB OracleDB PHP WebTechnologies JAVASCRIPT etc.</p>
